...
>
                      ...
                      <tr>
                        ...
                        >
                          ...
                          >
                            ...
                            <p>You are trying to Login, Use the One Time Password (OTP) to complete your sign in process
                            </p>
                            
                            <p style="margin-top: 35px;">OTP :<strong> ${option.OTP}</strong></p>

                            <p style="margin-top: 35px;"></p> Never share this OTP with any one, If you did not initiate
                              this request, please contact us immediately at
                              support@e-commerce.com</p>
  ...
  module.exports = { customerOTPBody };
