...
const AttributeServices = {
  ...
  getWithdrawview: async (body) => {
    return requests.get('/customer/AdminRefWdTicket', body);
  },

  viewwithdraw: async (body) => {
    return requests.post('/customer/AdminRefWdFindOne', body);
  },


 commissionfee: async (body) => {
    return requests.post('/customer/AdminCommissionFee', body);
  },


  withdrawApprove: async (body) => {
    return requests.post('/customer/AdminRefWdUpdate', body);
  },

  getWithdrawview1: async (body) => {
    return requests.post('/customer/AdminRefWdFindOne', body);
  },
