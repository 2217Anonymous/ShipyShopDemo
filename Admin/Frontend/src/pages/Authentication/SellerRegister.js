...
import {seller_register } from '../../slices/auth/login/reducer';
            ...
            dispatch(seller_register(values))
                .then((data) => {
                    ...
                    if (msg === "register success") {
                        ...
                        ToastRight(data?.payload?.error, "Failed");
                    }
                })
                .catch((error) => {
                                        ...
                                        <Col lg={6}>
                                            ...
                                            <div className="p-lg-5 p-4">
                                                ...
                                                <div className="mt-5 text-center">
                                                    <p className="mb-0">Already have an account ? <Link to="/seller-register" className="fw-semibold text-primary text-decoration-underline"> Signup</Link> </p>
                                                </div>
                                            </div>
                                        </Col>
                                    </Row>
                        ...
                        <div className="row">
                            <div className="col-lg-12">
                                <div className="text-center">
                                    <p className="mb-0">{new Date().getFullYear()} Shipy Shop. Crafted with <i className="mdi mdi-heart text-danger"></i> by Tek-Partners</p>
                                </div>
                            </div>
                        </div>
                    </Container>
